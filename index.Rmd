...
### SPC for Number of Adults
```{r Weekly SPC}
renderPlotly(
  {
    data_weekly %>%
      ptd_spc(value_field = Adults,
              date_field = Week,
...
### SPC for Number of Children
```{r Weekly SPC Children}
renderPlotly(
  
  {
    
    data_weekly %>%
      ptd_spc(value_field = Children,
              date_field = Week,
              improvement_direction = "decrease"
              ) %>%
      ptd_create_plotly(point_size = 2)
...
### SPC for Number of Households
```{r Weekly SPC Households}
renderPlotly(
  
  {
    
    data_weekly %>%
      ptd_spc(value_field = Households,
              date_field = Week,
              improvement_direction = "decrease"
              ) %>%
      ptd_create_plotly(point_size = 2)
...
### SPC for Number of Requests
```{r Weekly SPC Requests}
renderPlotly(
