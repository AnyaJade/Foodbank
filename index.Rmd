...
# Creates a summary statistics table with a row for each month and a total row. Includes number of adults fed, number of children fed, number of requests made and number of first requests.
data_wrangle %>%
...
data_wrangle %>%
  ...
  ptd_spc(
    value_field = `Number of Requests`,
    date_field = Week,
